...
PRISM_CLASSPATH = ".:$(PRISM_DIR)/classes:$(PRISM_DIR)/lib/*:$(PRISM_DIR)/prism/classes:$(PRISM_DIR)/prism/lib/*:./src/:./lib/jackson-core-2.9.9.jar/:./lib/jackson-databind-2.9.9.3.jar/"
